...
9. `docs/TESTING.md` — evidence/testing rules
10. `docs/CHAT-HANDOFF.md` — previous canonical continuation handoff
11. `docs/CHAT-HANDOFF-2026-09-12.md` — longer dated deep-context handoff
