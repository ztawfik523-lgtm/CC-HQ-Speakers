...
/**
 * Client handler for the remaining legacy non-finite path: producer-fed RAW PCM and optional live streams.
 *
 * <p>Modern finite MP3/WAV playback is handled by {@link HQFiniteMediaClient}.</p>
 */
@OnlyIn(Dist.CLIENT)
public final class HQSpeakerClientHandler {
    ...
    private static final class SpeakerState {
        ...
        private void tickPosition(Level level, HQSpeakerSound currentSound, HQSpeakerAudioPacket currentPacket) {
            ...
            BlockPos blockPos = new BlockPos(
                currentPacket.blockX, currentPacket.blockY, currentPacket.blockZ);
            ...
            try {
                ...
                Vector3d local = new Vector3d(
                    currentPacket.blockX + 0.5,
                    currentPacket.blockY + 0.5,
                    currentPacket.blockZ + 0.5);
    ...
    public static final class HQSpeakerSound extends AbstractSoundInstance
        ...
        public boolean isStopped() {
            return streaming && stream.isDrained();
        }
